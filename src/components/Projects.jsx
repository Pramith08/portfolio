        ...
        <section id='project'>
            <div className="border-b border-neutral-900 pb-4">
                ...
                <div>{PROJECTS.map((projects, index) => (
                    <div className="mb-8 flex flex-wrap lg:justify-around" key={index}>
                        ...
                        <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 100 }} transition={{ duration: 1 }} className="w-full mx-w-xl lg:w-1/3">
